...
data <- read_tsv('inputdata/uveal_sort.tsv', show_col_types = F)
...
#--------# to Derek
#Derek_score <- c(score, scoreHBC)
#Derek_score <- as.data.frame(Derek_score)
#Derek_score <- cbind(score, metadata)
#write.table(Derek_score, 'med2/methylation_score_0617.tsv', quote=F, sep='\t')
#--------#
...
pdf("Figure_4A.pdf", width = 12, height = 7)
