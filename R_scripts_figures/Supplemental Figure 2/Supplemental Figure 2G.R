...
outdir <- "/Volumes/GoogleDrive/My Drive/Post-Doc/Uveal Melanoma/Manuscript/Figures/Supplemental Figure 8_10"
...
healthy_samples <- "/Users/derekwong/Library/CloudStorage/OneDrive-UHN/Post-Doc/Healthy_control_cohorts/combined_cohort/HBC_sample_list.txt"
