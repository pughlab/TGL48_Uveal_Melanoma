INPUTDIR=/cluster/projects/pughlab/external_data/TGL48_Uveal_Melanoma/TGL48_sWG/bam_short
base=/cluster/projects/pughlab/projects/uveal_melanoma/ichorCNA
outdir=$base/output/ichorCNA_short
wig=$base/output/wig_short
shdir=$base/sh_scripts/ichorCNA_short
