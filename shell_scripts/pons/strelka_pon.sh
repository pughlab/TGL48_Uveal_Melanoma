...
perl /cluster/projects/pughlab/projects/CHARM/pipeline-suite/scripts/strelka.pl \
...
-o /cluster/projects/pughlab/projects/uveal_melanoma/pipeline_output/panel_of_normals/Strelka \
-c slurm \
--remove \
--no-wait
