...
sites=/cluster/projects/pughlab/projects/uveal_melanoma/griffin/configs/sites.yaml #Use this for custom list
...
outdir=$basedir/output/nucleosome_profiling/custom
