...
sites=/cluster/projects/pughlab/bin/Griffin/sites/site_configs/TFBS_sites.yaml #Use this for TFBS
...
outdir=$basedir/output/nucleosome_profiling/TFBS
...
sbatch -p all -c 8 --mem 8G -t 48:00:00 $file
done
